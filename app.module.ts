...
import { MatSortModule,MatFormFieldModule,MatInputModule,MatCheckboxModule,MatTableModule } from '@angular/material';//required for using mat realted stuff within module
